...
from ophyd_async.core import (
    ...
    SoftSignalBackend,
    NotConnected,
    SignalRW, enhanced_gather, AsyncStatus,
)
...
async def test_enhanced_gather_populates_cancelled_error_message_on_timeout(set_to_delay: str,
    ...
    with pytest.raises(TimeoutError) as exc_info:
        gather_awaitable = enhanced_gather(plain_awaitable,
                                           async_status_device.set(1.0),
                                           task_wrapped)
